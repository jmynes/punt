...
export function KeyboardShortcuts() {
	...
	}, [addTicket, removeTicket, popUndo, pushRedo, popRedo, pushDeletedBatch, clearSelection, selectedTicketIds, showDeleteConfirm, showShortcuts, columns])
			...
			<DialogContent className="bg-zinc-950 border-zinc-800 max-w-2xl max-h-[80vh] overflow-y-auto">
				<DialogHeader>
					...
					<DialogDescription className="text-zinc-400">
						Press <kbd className="px-2 py-1 text-xs font-semibold text-zinc-300 bg-zinc-800 border border-zinc-700 rounded">?</kbd> to toggle this dialog
					</DialogDescription>
				</DialogHeader>
