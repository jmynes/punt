                ...
                {sessions.map((session) => (
                  ...
                  >
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-6 w-6 opacity-0 group-hover:opacity-100 group-data-[selected=true]:opacity-100 shrink-0 ml-2 bg-red-950/50 hover:bg-red-900/80 text-red-400 hover:text-red-300 border border-red-800/50 hover:border-red-700/70 rounded"
